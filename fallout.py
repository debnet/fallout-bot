...
class Fallout(commands.Cog):
    ...
    SKILLS = {
        ('sg', 'sw', 'small', 'léger'): 'small_guns',
        ('bg', 'bw', 'big', 'lourd'): 'big_guns',
        ('eg', 'ew', 'energy', 'energie'): 'energy_weapons',
        ('un', 'nu', 'mains', 'nues'): 'unarmed',
        ('me', 'melee', 'mêlée'): 'melee_weapons',
        ('th', 'throw', 'jet'): 'throwing',
        ('fa', 'ps', 'first', 'aid', 'premiers', 'secours', 'soins'): 'first_aid',
        ('dc', 'doc', 'med', 'docteur', 'medecine'): 'doctor',
        ...
        ('rp', 'réparation', 'réparations'): 'repair',
        ('sp', 'di', 'discours', 'persuation'): 'speech',
